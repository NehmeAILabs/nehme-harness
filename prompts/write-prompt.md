...
When the user provides a skill definition (from superpower, claude-plugins, or a custom skill) and asks to convert it into a nehme-harness prompt:
...
4. **Add nehme-harness-specific sections** — include Anti-Repetition Rules, Tool Usage Guidelines, Error Recovery, and Safety Rules as applicable to the prompt's mode.
